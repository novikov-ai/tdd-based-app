...
Чтобы код и тесты следовали проектному дизайну, я из каждого требования к приложению формирую формальную спецификацию, основанную на пред и пост условиях. 
...
Подобную операцию произвел для множества других функций и в итоге функции как будто сами выстроились в логичный пазл, который удобно читать и развивать. 
